...
ssh -i der-nackte-halloumi-api-travis $SERVER_ADDRESS "MIGRATIONS_IMAGE_TAG=$TRAVIS_BUILD_NUMBER docker stop migrations && docker-compose up --build -d migrations && docker wait migrations"
